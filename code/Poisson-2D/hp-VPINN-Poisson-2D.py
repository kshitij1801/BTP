...
#%%
    ...
    ax.plot_surface(x_test_plot, y_test_plot, u_test_plot, rstride=1, cstride=1,cmap='viridis', edgecolor='none')
    ...
    fig = plt.figure()
    ax = plt.axes(projection = '3d')
    ax.plot_surface(x_test_plot, y_test_plot, abs(u_test_plot - u_pred_plot), rstride=1, cstride=1,cmap='viridis', edgecolor='none')
